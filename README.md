...
- `Packages/manifest.json` – Package manifest with the Unity Inference Engine (`com.unity.ai.inference`).
...
1. Open the project with Unity 6.2 or newer.
...
6. (Optional) Add the `BreathingModelController` to the scene and assign a Sentis `ModelAsset`.  Feed preprocessed microphone data into the controller to modulate the visuals in real time.
